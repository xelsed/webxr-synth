...
#define LOW_PRECISION`),t}function N0(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===cd?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===ld?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===ai&&(t="SHADOWMAP_TYPE_VSM"),t}function L0(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Fs:case Us:t="ENVMAP_TYPE_CUBE";break;case ca:t="ENVMAP_TYPE_CUBE_UV";break}return t}function O0(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Us:t="ENVMAP_MODE_REFRACTION";break}return t}function F0(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case vl:t="ENVMAP_BLENDING_MULTIPLY";break;case Tp:t="ENVMAP_BLENDING_MIX";break;case bp:t="ENVMAP_BLENDING_ADD";break}return t}function U0(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function k0(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=N0(e),l=L0(e),h=O0(e),u=F0(e),d=U0(e),p=E0(e),_=w0(r),g=s.createProgram();let m,f,T=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(dr).join(`
`)),o=al(o),o=Ru(o,e),o=Du(o,e),a=al(a),a=Ru(a,e),a=Du(a,e),o=Pu(o),a=Pu(a),e.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`)+`
`+f);const M=T+m+o,v=T+f+a,x=wu(s,s.VERTEX_SHADER,M),E=wu(s,s.FRAGMENT_SHADER,v);s.attachShader(g,x),s.attachShader(g,E),e.index0AttributeName!==void 0?s.bindAttribLocation(g,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(g,0,"position"),s.linkProgram(g);function A(R){if(i.debug.checkShaderErrors){const P=s.getProgramInfoLog(g)||"",L=s.getShaderInfoLog(x)||"",F=s.getShaderInfoLog(E)||"",H=P.trim(),k=L.trim(),z=F.trim();let V=!0,j=!0;if(s.getProgramParameter(g,s.LINK_STATUS)===!1)if(V=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,g,x,E);else{const K=Cu(s,x,"vertex"),tt=Cu(s,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(g,s.VALIDATE_STATUS)+`
